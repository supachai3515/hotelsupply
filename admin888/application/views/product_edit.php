<div id="page-wrapper" ng-app="myApp">
    <div class="container-fluid" ng-controller="myCtrl">
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <input id="member_discount" name="member_discount" type="number" value="<?php echo $product_data['member_discount']; ?>" placeholder="ราคา Dealer" class="form-control input-md">
            </div>
        </div>
