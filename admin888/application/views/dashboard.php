            ...
            <div class="col-lg-3 col-md-6">
                <div class="panel panel-yellow">
                    <div class="panel-heading">
                        <div class="row">
                            <div class="col-xs-12 text-right">
                                <div class="huge"><?php echo $get_po_orders_today['count'] ?></div>
                                <div>ใบเสนอราคาวันนี้</div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <div class="row">
                            <div class="col-xs-12 text-right">
                                <div class="huge"><span ng-bind="<?php if ($get_orders_today['total'] > 0) {
                                    echo $get_po_orders_today['total'];
                                }else { echo 0; } ?>"></span></div>
                                <div>ยอดใบเสนอราคาวันนี้</div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-md-6">
            ...
            <div class="col-md-6">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"><i class="fa fa-clock-o fa-fw"></i> สถานะใบเสนอราคา</h3>
                    </div>
                    <div class="panel-body">
                        <div class="list-group">
                        <?php foreach ($get_po_order_status as $value): ?>
                                <a href="<?php echo base_url('po_orders') ?>" class="list-group-item">
                                    <span class="badge"><?php echo $value['count'] ?></span>
                                    <?php echo $value['name'] ?>
                                </a> 
                        <?php endforeach ?>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"><i class="fa fa-money fa-fw"></i> ใบเสนอราคาล่าสุด</h3>
                    </div>
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                <tbody>
                                <?php foreach ($get_po_orders as $value): ?>
                                    <tr>
                                        <td><?php echo $value['id'] ?>
                                        <td><?php echo date("d-m-Y H:i", strtotime($value['date']));?></td>
                                        <td><strong ng-bind="<?php echo $value['total'];?> | currency:'฿':0"></strong></td>
                                        <td><a class="btn btn-xs btn-info" href="<?php echo base_url('po_orders/edit/'.$value['id']) ?>" role="button"><i class="fa fa-eye"></i></a></td> 
                                    </tr>
                                <?php endforeach ?>
                                </tbody>
                            </table>
